    ...
    <div className={b.menu}>
      <div className={b.footer}>
        ...
        <div className={b.footer_2}>
          <h1>Контакты</h1>
          <div className={b.footer_3}>
            <div>
              <a href="https://go.2gis.com/m9l8m">
              <svg
        ...
        <div className={b.react_1}>
          <h1>Меню</h1>
          <li>
            <a href=""><b>Автомобили</b></a>
          </li>
          <li>
            <a href=""><b>Покупка</b></a>
          </li>
          <li>
            <a href=""><b>Мир Mercedes-Benz</b></a>
          </li>
        </div>

        <div className={b.set}>
            <h1><b>Мы в <br /> соцсетях</b></h1>
          <li>
            <a href="">
              <svg
                xmlns="http://www.w3.org/2000/svg"
